...
a.dbg.document).css("top",-a.dbg_canvas_info.y).css("left",-a.dbg_canvas_info.x)};a.dbg_timer=null;a.dbg_update=function(){null!==a.dbg&&null===a.dbg_timer&&(a.dbg_timer=setTimeout(a.hook("ComponentJS:plugin:debugger:settimeout:func","pass",function(){a.dbg_update_once();a.dbg_timer=null}),250))};a.dbg_update_once=function(){a.dbg_state_invalid.console&&(a.jq(".dbg .console .text",a.dbg.document).html(a.dbg_logbook),a.jq(".dbg .console",a.dbg.document).scrollTop(a.jq(".dbg .console .text",a.dbg.document).height()),
a.dbg_state_invalid.console=!0);if(a.dbg_state_invalid.components||a.dbg_state_invalid.requests||a.dbg_state_invalid.states){var c,b,d;if(a.dbg_state_invalid.components||a.dbg_state_invalid.states)c=a.root.walk_down(function(b,c,d,e){if(e){e=b=0;for(var f=c.children(),g=0;g<f.length;g++)b+=a.annotation(f[g],"debugger_width"),e+=a.annotation(f[g],"debugger_total");0===e&&b++;e++;a.annotation(c,"debugger_width",b);a.annotation(c,"debugger_total",e)}else a.annotation(c,"debugger_depth",b),d=b>d?b:d;
return d},1),b=a.annotation(a.root,"debugger_width"),d=a.annotation(a.root,"debugger_total");if(a.dbg_state_invalid.components||a.dbg_state_invalid.requests){var f=0,g;for(g in a.state_requests)a.isown(a.state_requests,g)&&f++;a.jq(".dbg .status .text",a.dbg.document).html("Created Components: <b>"+d+"</b>, Pending Transition Requests: <b>"+f+"</b>");a.dbg_state_invalid.requests=!0}if(a.dbg_state_invalid.components||a.dbg_state_invalid.states){var e=a.jq(".dbg .viewer canvas",a.dbg.document).get(0);
if("undefined"===typeof e)return;var e=e.getContext("2d"),k=a.jq(".dbg .viewer canvas",a.dbg.document).height()-20;d=a.jq(".dbg .viewer canvas",a.dbg.document).width()-20;var w=Math.floor(d/b),q=Math.floor(k/(c+1)),y=Math.floor(w/8),u=Math.floor(q/4);e.clearRect(0,0,d,k);var v=a.dbg_natural;a.root.walk_down(function(b,c,d,f){if(f){f=a.annotation(c,"debugger_depth");var g,m;if(1===a.annotation(c,"debugger_total"))b=10+w*d++,f=v?k-q*f-q+10:q*f-10,g=w-y,m=q-u;else{var h=c.children();b=a.annotation(h[0],
"debugger_x");a.annotation(h[0],"debugger_y");g=b;1<h.length&&(g=a.annotation(h[h.length-1],"debugger_x"),a.annotation(h[h.length-1],"debugger_y"));b+=Math.ceil((g-b)/2);f=v?k-q*f-q+10:q*f-10;g=w-y;m=q-u;for(var p=0;p<h.length;p++){var r=a.annotation(h[p],"debugger_x"),n=a.annotation(h[p],"debugger_y"),s=a.annotation(h[p],"debugger_w");e.strokeStyle="#888888";e.lineWidth=2;e.beginPath();e.moveTo(b+Math.ceil(g/2),f+(v?0:m));e.lineTo(b+Math.ceil(g/2),f+(v?-Math.ceil(u/2):m+Math.ceil(u/2)));e.lineTo(r+
Math.ceil(s/2),f+(v?-Math.ceil(u/2):m+Math.ceil(u/2)));e.lineTo(r+Math.ceil(s/2),n+(v?m:0));e.stroke()}}h="";l.marked(c.obj(),"view")&&(h+="V");l.marked(c.obj(),"model")&&(h+="M");l.marked(c.obj(),"controller")&&(h+="C");l.marked(c.obj(),"service")&&(h+="S");"V"===h?(n="#14426f",p="#ffffff",s="#2068b0",r="#adcef0"):"M"===h?(n="#6f5014",p="#ffffff",s="#9a6f1c",r="#e8c581"):"S"===h?(n="#e8e8e8",p="#000000",s="#ffffff",r="#666666"):(n="#444444",p="#ffffff",s="#777777",r="#cccccc");e.save();e.fillStyle=
n;e.shadowColor="#888888";e.shadowBlur=6;e.shadowOffsetX=1;e.shadowOffsetY=1;e.fillRect(b,f,g,m);e.restore();e.fillStyle=s;e.fillRect(b,f+m/2,g,m/2);e.save();e.fillStyle=a.states[c.__state].color;e.shadowColor="#000000";e.shadowBlur=2;e.shadowOffsetX=0;e.shadowOffsetY=0;e.beginPath();e.arc(b+g-m/4-1,f+3*(m/4),m/4-3,0,2*Math.PI,!0);e.closePath();e.fill();e.restore();var n=!1,t;for(t in c.__state_guards)if("number"===typeof c.__state_guards[t]&&0!==c.__state_guards[t]){n=!0;break}n&&(e.save(),e.fillStyle=
"#ff0000",e.shadowColor="#000000",e.shadowBlur=2,e.shadowOffsetX=0,e.shadowOffsetY=0,e.beginPath(),e.arc(b+g-2*(m/4)-1,f+3*(m/4),m/4-3,0,2*Math.PI,!0),e.closePath(),e.fill(),e.restore());t=function(a,b,c,d,f){e.fillStyle=b;b=e.measureText(a);if(b.width>f)for(;""!==a;){b=e.measureText(a+"...");if(b.width<=f){a+="...";break}a=a.substr(0,a.length-1)}e.fillText(a,c,d,f)};n=0;""!==h&&(e.font="bold "+0.7*(m/2)+"px Helvetica, Arial, sans-serif",e.textBaseline="top",n=e.measureText(h),t(h,r,b+g-n.width-4,
f+2,n.width),n=n.width);e.font=0.7*(m/2)+"px Helvetica, Arial, sans-serif";e.textBaseline="top";t(c.name(),p,b+4,f+2,g-n-8);t(c.state(),r,b+4,f+m/2+2,g-m/2-8);a.annotation(c,"debugger_x",b);a.annotation(c,"debugger_y",f);a.annotation(c,"debugger_w",g);a.annotation(c,"debugger_h",m)}return d},0);var x=!1;a.jq(".dbg .viewer canvas",a.dbg.document).bind("mousedown",function(b){b.target===a.jq(".dbg .viewer canvas",a.dbg.document).get(0)&&(z(b),x=!0)});a.jq(".dbg .viewer canvas",a.dbg.document).bind("mousemove",
function(b){b.target===a.jq(".dbg .viewer canvas",a.dbg.document).get(0)&&x&&z(b)});a.jq(".dbg .viewer canvas",a.dbg.document).bind("mouseup",function(b){b.target===a.jq(".dbg .viewer canvas",a.dbg.document).get(0)&&(a.jq(".dbg .infobox",a.dbg.document).css("display","none"),x=!1)});var z=function(b){var c=b.offsetX,d=b.offsetY,e=null;a.root.walk_down(function(b,f,g,k){if(k){b=a.annotation(f,"debugger_x");g=a.annotation(f,"debugger_y");k=a.annotation(f,"debugger_w");var l=a.annotation(f,"debugger_h");
b<=c&&(c<=b+k&&g<=d&&d<=g+l)&&(e=f)}},0);null!==e&&(b=a.dbg_infobox_content(e),a.jq(".dbg .infobox",a.dbg.document).html(b),a.jq(".dbg .infobox",a.dbg.document).css("display","block"))}}a.dbg_state_invalid.components=!0;a.dbg_state_invalid.states=!0}};a.latch("ComponentJS:log",function(c){var b=!1;null!==a.dbg&&(a.dbg_log(c),b=!0);return b});a.latch("ComponentJS:state-change",function(){a.dbg_update()});a.latch("ComponentJS:state-invalidate",function(c){a.dbg_state_invalidate(c)})});
