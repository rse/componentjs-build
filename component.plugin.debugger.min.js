...
e.shadowBlur=2,e.shadowOffsetX=0,e.shadowOffsetY=0,e.beginPath(),e.arc(b+g-2*(m/4)-1,f+3*(m/4),m/4-3,0,2*Math.PI,!0),e.closePath(),e.fill(),e.restore());t=function(a,b,c,d,f){e.fillStyle=b;b=e.measureText(a);if(b.width>f)for(;""!==a;){b=e.measureText(a+"...");if(b.width<=f){a+="...";break}a=a.substr(0,a.length-1)}e.fillText(a,c,d,f)};n=0;""!==h&&(e.font="bold "+0.7*(m/2)+"px Helvetica, Arial, sans-serif",e.textBaseline="top",n=e.measureText(h),t(h,r,b+g-n.width-4,f+2,n.width),n=n.width);e.font=0.7*
(m/2)+"px Helvetica, Arial, sans-serif";e.textBaseline="top";t(c.name(),p,b+4,f+2,g-n-8);t(c.state(),r,b+4,f+m/2+2,g-m/2-8);a.annotation(c,"debugger_x",b);a.annotation(c,"debugger_y",f);a.annotation(c,"debugger_w",g);a.annotation(c,"debugger_h",m)}return d},0);var x=!1;a.jq(".dbg .viewer canvas",a.dbg.document).bind("mousedown",function(b){b.target===a.jq(".dbg .viewer canvas",a.dbg.document).get(0)&&(z(b),x=!0)});a.jq(".dbg .viewer canvas",a.dbg.document).bind("mousemove",function(b){b.target===
a.jq(".dbg .viewer canvas",a.dbg.document).get(0)&&x&&z(b)});a.jq(".dbg .viewer canvas",a.dbg.document).bind("mouseup",function(b){b.target===a.jq(".dbg .viewer canvas",a.dbg.document).get(0)&&(a.jq(".dbg .infobox",a.dbg.document).css("display","none"),x=!1)});var z=function(b){var c=b.offsetX,d=b.offsetY,e=null;a.root.walk_down(function(b,f,g,k){if(k){b=a.annotation(f,"debugger_x");g=a.annotation(f,"debugger_y");k=a.annotation(f,"debugger_w");var l=a.annotation(f,"debugger_h");b<=c&&c<=b+k&&g<=d&&
d<=g+l&&(e=f)}},0);null!==e&&(b=a.dbg_infobox_content(e),a.jq(".dbg .infobox",a.dbg.document).html(b),a.jq(".dbg .infobox",a.dbg.document).css("display","block"))}}a.dbg_state_invalid.components=!0;a.dbg_state_invalid.states=!0}};a.latch("ComponentJS:log",function(c){var b=!1;null!==a.dbg&&(a.dbg_log(c),b=!0);return b});a.latch("ComponentJS:state-change",function(){a.dbg_update()});a.latch("ComponentJS:state-invalidate",function(c){a.dbg_state_invalidate(c)})});
